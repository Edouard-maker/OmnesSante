...
if(isset($_GET['s']) AND !empty($_GET['s'])){
  ...
  $allusers=$database->query('SELECT * FROM medecin WHERE specialisation LIKE "%'.$recherche.'%"');
}?>
        ...
        <div class="wrapper">
            ...
            <div class="container section">
              ...
              <div class="col-md-3"></div>
                <div class="col-md-6">
                  <form method="get">
                    <br><input type="search" class="barre" name="s" placeholder="Recherchez une spécialisation">
