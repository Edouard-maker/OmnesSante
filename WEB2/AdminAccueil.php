        ...
        <div class="container-fluid text-center">
            <div class="row content">
                <div class="col-sm-8 text-left">
                    <h1 style="color: #071f32;"> Bienvenue sur votre page admin </h1>
                    <div id="infos" class="infos" style="display: none;">
                        ...
                        while ($row = mysqli_fetch_array($result)) {
                            ...
                            echo "<tr>";
                            echo "<th>Nom</th>";
                            echo "<td>" . $row['nomAdmin'] . "</td>";
                            echo "<tr>";
                            echo "<th>Prénom</th>";
                            echo "<td>" . $row['prenomAdmin'] . "</td>";
                            echo "<tr>";
                            echo "<th>Mail</th>";
                            echo "<td>" . $row['courrielAdmin'] . "</td>";
                            echo "<tr>";
                            echo "</table>";
                        }
                ...
                <div class="col-sm-2 sidenav">
                    ...
                    <p> <a id="myLink" href="AdminAccueil.php" onclick="fct();return false;" style="text-decoration: none; color:#32465c;"> Votre compte</a> </p>
                    <a>
                        <form action="AdminAccueil.php" role="search">
