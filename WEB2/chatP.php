...
if (isset($_GET['logout'])) {
    ...
    session_destroy();
    sleep(1);
    header("Location: ChatP.php"); //Rediriger l'utilisateur
}
...
function loginForm()
{
    ...
    <form action="PatientAccueil.php" role="search">
        <button class="bouton_retour_patient" style="background-color: #32465c; color: #f6f6f6;"> Retour sur votre accueil </button>
    </form>';
}
?>
<!DOCTYPE html>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function() {
                ...
                $("#exit").click(function() {
                    ...
                    if (exit == true) {
                        window.location = "ChatP.php?logout=true";
                        session_destroy();
                    }
                })
            });
