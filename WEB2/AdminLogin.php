...
if (isset($_POST['but_submit'])) {
    ...
    if ($uname != "" && $password != "") {
        ...
        $sql_query = "select count(*) as cntUser from administrateur where loginAdmin='" . $uname . "' and mdpAdmin='" . $password . "'";
...
<body>
    <div class="wrapper">
        ...
        <h2>Connexion</h2>
        <p> Entrez vos infos pour vous connecter à votre compte admin </p>
        <div class="container">
            <form method="post" action="">
                ...
                <p> Pas de compte ? <a href="AdminCreerCompte.php"> Créez-le ici </a>.</p>
            </form>
        </div>
    </div>
